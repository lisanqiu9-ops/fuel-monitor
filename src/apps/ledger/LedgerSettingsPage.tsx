...
export function LedgerSettingsPage({ cache, isImporting, error, onImport, onClear, onBackToToolbox }: Props) {
  ...
  return <div className="mx-auto max-w-2xl space-y-4">
    ...
    <section><h2 className="mb-2 px-1 text-xs font-black text-[#9a817e]">数据与安全</h2><div className="overflow-hidden rounded-2xl border border-white/80 bg-white/76 shadow-[0_10px_24px_rgba(91,72,72,0.07)]">
