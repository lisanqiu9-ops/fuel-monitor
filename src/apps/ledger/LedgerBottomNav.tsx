...
export function LedgerBottomNav({ activeTab, onChange }: Props) {
  return <nav aria-label="账本页面导航" className="fixed bottom-0 left-1/2 z-30 w-full max-w-[430px] -translate-x-1/2 border-t border-white/80 bg-[#fffaf4]/94 px-2 pb-[calc(8px+env(safe-area-inset-bottom,0px))] pt-2 shadow-[0_-12px_30px_rgba(91,72,72,0.08)] backdrop-blur-xl">
