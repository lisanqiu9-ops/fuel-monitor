...
export default function App() {
  ...
  return (
    <div className="app-shell w-full flex flex-col bg-[#1a1a18] overflow-hidden max-w-md mx-auto relative shadow-2xl">
      ...
      {/* Tab Bar */}
      <div className="app-bottom-nav fixed bottom-0 left-1/2 h-[72px] bg-[#1a1a18]/90 backdrop-blur-xl border-t border-white/5 flex items-center justify-around z-40 pb-safe">
        <button 
